...
function addFriendButton() {
    ...
    function addStar() {
        ...
        if (name_box) {
            ...
            name_box.innerHTML = name_box.innerHTML + "&nbsp;&nbsp;" + star_icon_svg;
            name_box.classList.add("flex", "items-center");
            let star = name_box.querySelector("svg");
            star.id = "star-icon";
...
function toggleFriend(){
    ...
    if(star_path.style.fill == not_friend_color){
